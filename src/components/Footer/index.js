    ...
    return (
        <footer className="footer fixed-bottom text-center d-flex justify-content-center flex-column p-2">
            ...
            <div className='justify-content-center'>
                <SocialMediaIconsReact borderColor="rgba(0,0,0,0)" borderWidth="0" borderStyle="solid" icon="instagram" iconColor="rgba(255,255,255,1)" backgroundColor="rgba(231,231,231,0)" iconSize="5" roundness="25%" url="https://www.instagram.com/buckwheat37" size="30" />
